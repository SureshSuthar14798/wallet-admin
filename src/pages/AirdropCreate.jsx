              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="bg-inputBg/50 border-b border-border-custom">
                    ...
                    <th className="py-4 px-4 text-[10px] font-bold text-text-muted uppercase tracking-wider text-center">{t('col_crypto')}</th>
                    <th className="py-4 px-4 text-[10px] font-bold text-text-muted uppercase tracking-wider">{t('common_date')}</th>
                    <th className="py-4 px-4 text-[10px] font-bold text-text-muted uppercase tracking-wider text-right">{t('col_total_price')}</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
        ...
        <div className="lg:col-span-4 space-y-4">
            <div className="bg-panel border border-border-custom rounded-2xl p-6 shadow-xl relative overflow-hidden">
              ...
              <div className="space-y-5 relative z-10 mt-1">
                ...
                <div className="space-y-1.5">
                  <label className="text-[10px] font-black text-text-muted uppercase tracking-widest flex">{t('col_quantity')}</label>
                ...
                <div className="space-y-1.5">
                  <label className="text-[10px] font-black text-text-muted uppercase tracking-widest flex">{t('col_reason')}</label>
                ...
                <div className="space-y-1.5">
                  <label className="text-[10px] font-black text-text-muted uppercase tracking-widest leading-none flex">{t('label_num_payments')}</label>
                ...
                <div className="space-y-1.5">
                  <label className="text-[10px] font-black text-text-muted uppercase tracking-widest leading-none flex">{t('label_payment_amount')}</label>
