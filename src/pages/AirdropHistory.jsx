      ...
      <div className="bg-panel border border-border-custom rounded-2xl p-4 sm:p-6 shadow-sm">
        <div className="flex flex-col lg:flex-row lg:items-end gap-4">
          <div className="space-y-2">
            <label className="text-[10px] font-black text-text-muted uppercase tracking-widest ml-1">{t('nav_airdrop_management')} {t('common_date')}</label>
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="bg-inputBg/50 border-b border-border-custom">
                ...
                <th className="py-4 px-6 text-[10px] font-bold text-text-muted uppercase tracking-wider text-center">{t('col_crypto')}</th>
                <th className="py-4 px-6 text-[10px] font-bold text-text-muted uppercase tracking-wider text-right">{t('col_quantity')}</th>
                <th className="py-4 px-6 text-[10px] font-bold text-text-muted uppercase tracking-wider">{t('col_reason')}</th>
                <th className="py-4 px-6 text-[10px] font-bold text-text-muted uppercase tracking-wider">{t('col_reason_detail')}</th>
                <th className="py-4 px-6 text-[10px] font-bold text-text-muted uppercase tracking-wider text-right">{t('common_date')}</th>
              </tr>
            </thead>
            <tbody>
              <tr>
