        ...
        <div className="flex flex-col lg:flex-row lg:items-end gap-4">
          ...
          <div className="flex-1 flex flex-wrap items-end gap-3 justify-end">
            <div className="flex-1 min-w-[120px] space-y-2">
                <label className="text-[10px] font-black text-text-muted uppercase tracking-widest ml-1">{t('col_crypto')}</label>
          ...
          <table className="w-full text-left min-w-[1600px]">
            <thead>
              <tr className="bg-inputBg/50 border-b border-border-custom">
                ...
                <th className="py-4 px-4 text-[10px] font-bold text-text-muted uppercase tracking-wider">{t('col_crypto')}</th>
                <th className="py-4 px-4 text-[10px] font-bold text-text-muted uppercase tracking-wider">{t('col_txid')}</th>
                <th className="py-4 px-4 text-[10px] font-bold text-text-muted uppercase tracking-wider">{t('col_sent_address')}</th>
                <th className="py-4 px-4 text-[10px] font-bold text-text-muted uppercase tracking-wider">{t('col_recv_address')}</th>
                <th className="py-4 px-4 text-[10px] font-bold text-text-muted uppercase tracking-wider">{t('col_sender_id')}</th>
                <th className="py-4 px-4 text-[10px] font-bold text-text-muted uppercase tracking-wider">{t('col_recv_member_id')}</th>
                <th className="py-4 px-4 text-[10px] font-bold text-text-muted uppercase tracking-wider text-center">{t('col_tx_status')}</th>
                <th className="py-4 px-4 text-[10px] font-bold text-text-muted uppercase tracking-wider text-right">{t('col_quantity')}</th>
                <th className="py-4 px-4 text-[10px] font-bold text-text-muted uppercase tracking-wider">{t('col_tx_type')}</th>
                <th className="py-4 px-4 text-[10px] font-bold text-text-muted uppercase tracking-wider">{t('common_date')}</th>
