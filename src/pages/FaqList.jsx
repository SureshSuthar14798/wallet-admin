            ...
            <table className="w-full text-left">
              <thead>
                <tr className="bg-inputBg/50 border-b border-border-custom">
                  ...
                  <th className="py-4 px-6 text-[10px] font-bold text-text-muted uppercase tracking-wider text-center">{t('faq_question_label')}</th>
                  <th className="py-4 px-6 text-[10px] font-bold text-text-muted uppercase tracking-wider text-center">{t('faq_answer_label')}</th>
                  <th className="py-4 px-6 text-[10px] font-bold text-text-muted uppercase tracking-wider text-center">{t('common_date')}</th>
          ...
          <div className="bg-panel border border-border-custom w-full max-w-2xl rounded-[20px] shadow-2xl relative z-10 animate-scale-in overflow-hidden">
            <div className="p-5 border-b border-border-custom relative">
              <div className="space-y-1">
                ...
                <p className="text-[11px] text-text-muted font-bold tracking-tight uppercase opacity-60">{t('faq_reg_subtitle')}</p>
              </div>
              <button
