  ...
  return (
    <div className="animate-enter space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h2 className="text-2xl font-bold text-text-main tracking-tight">Service Center</h2>
          <p className="text-xs text-text-muted font-medium">Manage user inquiries and support tickets</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        {[
          { label: 'Unassigned', value: '12', icon: <MessageSquare className="text-amber-500"/> },
          { label: 'In Progress', value: '45', icon: <Clock className="text-primary"/> },
          { label: 'Resolved', value: '128', icon: <CheckCircle className="text-emerald-500"/> },
        ].map((stat) => (
